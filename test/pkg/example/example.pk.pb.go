...
func (*UnimplementedConsumer) ConsumeTestOne(_ context.Context, _ *TestOne, ack func(err error)) error {
	ack(nil)
	return nil
}

func (*UnimplementedConsumer) ConsumeTestTwo(_ context.Context, _ *TestTwo, ack func(err error)) error {
	ack(nil)
	return nil
}
